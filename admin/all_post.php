...
$all = "SELECT * FROM posts WHERE post_status NOT IN ('trash') && type = 'post'";
$result = mysqli_query($con,$all);
$TotalPost = mysqli_num_rows($result);

$publish = "SELECT * FROM posts WHERE post_status = 'publish'  && type = 'post'";
$result = mysqli_query($con,$publish);
$PublishPost = mysqli_num_rows($result);

$draft = "SELECT * FROM posts WHERE post_status = 'draft'  && type = 'post'";
$result = mysqli_query($con,$draft);
$DraftPost = mysqli_num_rows($result);

$trash = "SELECT * FROM posts WHERE post_status = 'trash'  && type = 'post'";
             ...
             <div class="tab-pane active" id="tab_1">
               <table id="example1" class="table table-bordered table-hover">
                 ...
                 <tbody>
                  <?php
                    $sr = 0;
                    $sql = "SELECT * FROM posts WHERE post_status NOT IN ('trash')  && type = 'post' ORDER BY id DESC";
               ...
               <table id="example1" class="table table-bordered table-hover">
                 ...
                 <tbody>
                  <?php
                    $sr = 0;
                    $con = new mysqli("localhost","root","","blog");
                    $sql = "SELECT * FROM posts WHERE post_status='publish' && type = 'post' ORDER BY id DESC";
                    $result = mysqli_query($con,$sql);
                    while ($row = mysqli_fetch_array($result)) {
                      $id = $row['id'];
                      $title = $row['title'];
               ...
               <table id="example1" class="table table-bordered table-hover">
                 ...
                 <tbody>
                  <?php
                    $sr = 0;
                    $con = new mysqli("localhost","root","","blog");
                    $sql = "SELECT * FROM posts WHERE post_status='draft' && type = 'post' ORDER BY id DESC";
                    $result = mysqli_query($con,$sql);
                    while ($row = mysqli_fetch_array($result)) {
                      $id = $row['id'];
                      $title = $row['title'];
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                 <?php
                   $sr = 0;
                   $con = new mysqli("localhost","root","","blog");
                   $sql = "SELECT * FROM posts WHERE post_status='trash' && type = 'post' ORDER BY id DESC";
                   $result = mysqli_query($con,$sql);
                   while ($row = mysqli_fetch_array($result)) {
                     $id = $row['id'];
                     $title = $row['title'];
